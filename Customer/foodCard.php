            ...
            <div class="p-4 flex flex-col gap-3">
                ...
                <div class="flex justify-between items-center mt-1">
                    <div class="flex w-full justify-between items-center">
                        <div class="text-lg font-semibold <?php echo($status=='close')?'':'text-yellow-500'; ?> ">₹299</div>
                        <div class=" bg-yellow-500 text-black text-xs font-semibold px-4 p-1 rounded-md z-10">
