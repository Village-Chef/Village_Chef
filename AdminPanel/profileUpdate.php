        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <main class="flex-1 relative overflow-y-auto focus:outline-none p-6">
                <div class="max-w-4xl mx-auto">
                    ...
                    <!-- Profile Update Form -->
                    <form method="POST" enctype="multipart/form-data" class="bg-gray-800 rounded-2xl border border-gray-700 p-6 space-y-8">
                        <!-- Avatar Section -->
                        <div class="text-center">
                            <div class="relative inline-block">
                                <img class="h-32 w-32 rounded-full border-4 border-accent/30 object-cover mx-auto"
                                    ...
                                    alt="Profile photo">
                                <button type="button" class="absolute bottom-0 right-0 bg-accent p-2 rounded-full hover:bg-accent/90 transition-colors">
