                ...
                <div class="max-w-2xl mx-auto">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <select id="cuisine_id" name="cuisine_id"
                                    ...
                                    <?php foreach ($cuisines as $cuisine): ?>
                                        <option value="<?php echo $cuisine['cuisine_id']; ?>"
                                            <?php echo $cuisine['cuisine_id'] == $item['cuisine_id'] ? 'selected' : ''; ?>>
                                            <?php echo $cuisine['cuisine_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-300 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent"
                                    placeholder="Describe the menu item"><?php echo $item['description']; ?></textarea>
                            </div>
                            <div class="col-span-2">
                   ...
                   peer-checked:hover:bg-yellow-500">
                            ...
                            <div class="col-span-2">
                                ...
                                <div id="image-preview" class="mt-3 <?php echo empty($item['image_url']) ? 'hidden' : ''; ?>">
                                    <img id="preview-img" src="<?php echo $item['image_url']; ?>" alt="Image preview"
                        ...
                        <div class="flex justify-end space-x-3 mt-6">
                            ...
                            <button type="submit" name="btnUpdateMenuItem"
